...
HD_PWD='C:/work/delay/delay.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log delay_data.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source delay_data.tcl
